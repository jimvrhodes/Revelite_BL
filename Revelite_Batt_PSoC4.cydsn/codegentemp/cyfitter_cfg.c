...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT07), 0x00000030u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT08), 0x00000021u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B00), 0x80000005u);

	/* CYDEV_CLK_DIVIDER_C00 Starting address: CYDEV_CLK_DIVIDER_C00 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x80000020u);

	/* CYDEV_CLK_DIVIDER_A01 Starting address: CYDEV_CLK_DIVIDER_A01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x80000022u);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x8000002Fu);
...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x000000F4u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x000000F4u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT0_TR_CTRL0), 0x000F00D0u);

		/* TCPWM_CNT2 Starting address: CYDEV_TCPWM_CNT2_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT2_TR_CTRL0), 0x0000001Bu);

		/* TCPWM_CNT3 Starting address: CYDEV_TCPWM_CNT3_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT3_TR_CTRL0), 0x0000001Eu);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INTR_SELECT */
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x00000005u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00240249u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x00000005u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x0000018Eu);
	CY_SET_REG32((void *)(CYREG_PRT1_PC2), 0x00000080u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x000000F4u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00000200u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC2), 0x000000F4u);
