...
#define PWM_2_PWM_SWITCH_SIGNAL_PRESENT      (1lu)
...
/* PWM Mode */
#define PWM_2_PWM_PERIOD_VALUE               (65535lu)
#define PWM_2_PWM_PERIOD_BUF_VALUE           (65535lu)
#define PWM_2_PWM_PERIOD_SWAP                (0lu)
#define PWM_2_PWM_COMPARE_VALUE              (0lu)
#define PWM_2_PWM_COMPARE_BUF_VALUE          (0lu)
#define PWM_2_PWM_COMPARE_SWAP               (1lu)
