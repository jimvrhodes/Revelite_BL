// ======================================================================
// Revelite_Batt_PSoC4.v generated from TopDesign.cysch
// 10/29/2025 at 17:02
...
module ADC_SAR_SEQ_P4_v2_60_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("61148f5b-18a7-4850-b00a-544e72506be5/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam cy_psoc4_sarmux_8.input_mode = "00000";
	...
	cy_clock_v1_0
		#(.id("61148f5b-18a7-4850-b00a-544e72506be5/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("3d2b8b51-6983-464d-b02d-75c58c31789b"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("548d5e5c-1b5b-4868-92d5-328b7262d15e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__VSENSE_net;
	wire [0:0] tmpFB_0__VSENSE_net;
	wire [0:0] tmpIO_0__VSENSE_net;
	wire [0:0] tmpINTERRUPT_0__VSENSE_net;
	electrical [0:0] tmpSIOVREF__VSENSE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		VSENSE
		 (.oe(tmpOE__VSENSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VSENSE_net[0:0]}),
		  .analog({Net_25}),
		  .io({tmpIO_0__VSENSE_net[0:0]}),
		  .siovref(tmpSIOVREF__VSENSE_net),
		  .interrupt({tmpINTERRUPT_0__VSENSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VSENSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_SENSE_net;
	wire [0:0] tmpFB_0__VBUS_SENSE_net;
	wire [0:0] tmpIO_0__VBUS_SENSE_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_SENSE_net;
	electrical [0:0] tmpSIOVREF__VBUS_SENSE_net;

	cy_psoc3_pins_v1_10
		#(.id("12875588-ca25-41da-9b58-9ab30552e807"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_SENSE
		 (.oe(tmpOE__VBUS_SENSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_SENSE_net[0:0]}),
		  .analog({Net_26}),
		  .io({tmpIO_0__VBUS_SENSE_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_SENSE_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_SENSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_SENSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("f35f06aa-7ea9-40ca-b94b-c2477212d2ba"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3d5ea09-3e2a-4064-bea8-3262a403f599"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__BATT_NTC_net;
	wire [0:0] tmpFB_0__BATT_NTC_net;
	wire [0:0] tmpIO_0__BATT_NTC_net;
	wire [0:0] tmpINTERRUPT_0__BATT_NTC_net;
	electrical [0:0] tmpSIOVREF__BATT_NTC_net;

	cy_psoc3_pins_v1_10
		#(.id("5bb05de6-76df-4225-8c49-cebad17667a0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BATT_NTC
		 (.oe(tmpOE__BATT_NTC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BATT_NTC_net[0:0]}),
		  .analog({Net_182}),
		  .io({tmpIO_0__BATT_NTC_net[0:0]}),
		  .siovref(tmpSIOVREF__BATT_NTC_net),
		  .interrupt({tmpINTERRUPT_0__BATT_NTC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BATT_NTC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__THERM_net;
	wire [0:0] tmpFB_0__THERM_net;
	wire [0:0] tmpIO_0__THERM_net;
	wire [0:0] tmpINTERRUPT_0__THERM_net;
	electrical [0:0] tmpSIOVREF__THERM_net;

	cy_psoc3_pins_v1_10
		#(.id("68a9294c-0a1b-4d64-a631-7b04abc0dd4c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		THERM
		 (.oe(tmpOE__THERM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__THERM_net[0:0]}),
		  .analog({Net_173}),
		  .io({tmpIO_0__THERM_net[0:0]}),
		  .siovref(tmpSIOVREF__THERM_net),
		  .interrupt({tmpINTERRUPT_0__THERM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__THERM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__VBAT_SENSE_net;
	wire [0:0] tmpFB_0__VBAT_SENSE_net;
	wire [0:0] tmpIO_0__VBAT_SENSE_net;
	wire [0:0] tmpINTERRUPT_0__VBAT_SENSE_net;
	electrical [0:0] tmpSIOVREF__VBAT_SENSE_net;

	cy_psoc3_pins_v1_10
		#(.id("c9584816-0576-498f-9c25-8d16dc39e475"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBAT_SENSE
		 (.oe(tmpOE__VBAT_SENSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBAT_SENSE_net[0:0]}),
		  .analog({Net_212}),
		  .io({tmpIO_0__VBAT_SENSE_net[0:0]}),
		  .siovref(tmpSIOVREF__VBAT_SENSE_net),
		  .interrupt({tmpINTERRUPT_0__VBAT_SENSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBAT_SENSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ACTLED_net;
	wire [0:0] tmpFB_0__ACTLED_net;
	wire [0:0] tmpIO_0__ACTLED_net;
	wire [0:0] tmpINTERRUPT_0__ACTLED_net;
	electrical [0:0] tmpSIOVREF__ACTLED_net;

	cy_psoc3_pins_v1_10
		#(.id("1724d5a9-4108-4278-89bf-c38d9a2ce0a1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ACTLED
		 (.oe(tmpOE__ACTLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ACTLED_net[0:0]}),
		  .io({tmpIO_0__ACTLED_net[0:0]}),
		  .siovref(tmpSIOVREF__ACTLED_net),
		  .interrupt({tmpINTERRUPT_0__ACTLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ACTLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ERRLED_net;
	wire [0:0] tmpFB_0__ERRLED_net;
	wire [0:0] tmpIO_0__ERRLED_net;
	wire [0:0] tmpINTERRUPT_0__ERRLED_net;
	electrical [0:0] tmpSIOVREF__ERRLED_net;

	cy_psoc3_pins_v1_10
		#(.id("8f82d407-e1a6-4ae7-8dcf-e79fc9b5b6c5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ERRLED
		 (.oe(tmpOE__ERRLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ERRLED_net[0:0]}),
		  .io({tmpIO_0__ERRLED_net[0:0]}),
		  .siovref(tmpSIOVREF__ERRLED_net),
		  .interrupt({tmpINTERRUPT_0__ERRLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ERRLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OC_FLAG_net;
	wire [0:0] tmpFB_0__OC_FLAG_net;
	wire [0:0] tmpIO_0__OC_FLAG_net;
	wire [0:0] tmpINTERRUPT_0__OC_FLAG_net;
	electrical [0:0] tmpSIOVREF__OC_FLAG_net;

	cy_psoc3_pins_v1_10
		#(.id("ba8e2253-5b64-427c-acbe-83b39f15a21a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OC_FLAG
		 (.oe(tmpOE__OC_FLAG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OC_FLAG_net[0:0]}),
		  .io({tmpIO_0__OC_FLAG_net[0:0]}),
		  .siovref(tmpSIOVREF__OC_FLAG_net),
		  .interrupt({tmpINTERRUPT_0__OC_FLAG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OC_FLAG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__USB_INT_net;
	wire [0:0] tmpIO_0__USB_INT_net;
	wire [0:0] tmpINTERRUPT_0__USB_INT_net;
	electrical [0:0] tmpSIOVREF__USB_INT_net;

	cy_psoc3_pins_v1_10
		#(.id("a45cb5a8-2d0a-44ea-9a13-857bd175ed0a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		USB_INT
		 (.oe(tmpOE__USB_INT_net),
		  .y({1'b0}),
		  .fb({Net_222}),
		  .io({tmpIO_0__USB_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__USB_INT_net),
		  .interrupt({tmpINTERRUPT_0__USB_INT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__USB_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LATCH_INT_net;
	wire [0:0] tmpIO_0__LATCH_INT_net;
	wire [0:0] tmpINTERRUPT_0__LATCH_INT_net;
	electrical [0:0] tmpSIOVREF__LATCH_INT_net;

	cy_psoc3_pins_v1_10
		#(.id("ea89e251-dc78-4547-921e-d67acb727d8e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LATCH_INT
		 (.oe(tmpOE__LATCH_INT_net),
		  .y({1'b0}),
		  .fb({Net_220}),
		  .io({tmpIO_0__LATCH_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__LATCH_INT_net),
		  .interrupt({tmpINTERRUPT_0__LATCH_INT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LATCH_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CHRG_OK_net;
	wire [0:0] tmpFB_0__CHRG_OK_net;
	wire [0:0] tmpIO_0__CHRG_OK_net;
	wire [0:0] tmpINTERRUPT_0__CHRG_OK_net;
	electrical [0:0] tmpSIOVREF__CHRG_OK_net;

	cy_psoc3_pins_v1_10
		#(.id("2f02a419-4072-4e2e-9eeb-f8bd11628b15"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CHRG_OK
		 (.oe(tmpOE__CHRG_OK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CHRG_OK_net[0:0]}),
		  .io({tmpIO_0__CHRG_OK_net[0:0]}),
		  .siovref(tmpSIOVREF__CHRG_OK_net),
		  .interrupt({tmpINTERRUPT_0__CHRG_OK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CHRG_OK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CMP_OUT_net;
	wire [0:0] tmpFB_0__CMP_OUT_net;
	wire [0:0] tmpIO_0__CMP_OUT_net;
	wire [0:0] tmpINTERRUPT_0__CMP_OUT_net;
	electrical [0:0] tmpSIOVREF__CMP_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("3ddc8b58-f83a-4c71-a0b2-cd993b9ac891"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CMP_OUT
		 (.oe(tmpOE__CMP_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CMP_OUT_net[0:0]}),
		  .io({tmpIO_0__CMP_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__CMP_OUT_net),
		  .interrupt({tmpINTERRUPT_0__CMP_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CMP_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OTG_VAP_net;
	wire [0:0] tmpFB_0__OTG_VAP_net;
	wire [0:0] tmpIO_0__OTG_VAP_net;
	wire [0:0] tmpINTERRUPT_0__OTG_VAP_net;
	electrical [0:0] tmpSIOVREF__OTG_VAP_net;

	cy_psoc3_pins_v1_10
		#(.id("a7f90649-bd15-4c7f-a50f-7a3bc316a8d4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OTG_VAP
		 (.oe(tmpOE__OTG_VAP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OTG_VAP_net[0:0]}),
		  .io({tmpIO_0__OTG_VAP_net[0:0]}),
		  .siovref(tmpSIOVREF__OTG_VAP_net),
		  .interrupt({tmpINTERRUPT_0__OTG_VAP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OTG_VAP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
